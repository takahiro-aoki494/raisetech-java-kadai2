...
public class NetDev {
    public static void main(String[] args) {
        ...
        List<Device> DeviceList = List.of(
                new Device("Catalyst 3650 シリーズ ", "Cisco", "Switch"),
                new Device("Catalyst 9200 シリーズ ", "Cisco", "Switch"),
                new Device("Catalyst 8300 シリーズ ", "Cisco", "Router"),
                new Device("ASR 9000 シリーズ ", "Cisco", "Router"),
                new Device("EX4100 シリーズ ", "Juniper", "Switch"),
                new Device("EX3400 シリーズ ", "Juniper", "Switch"),
                new Device("MX10004 シリーズ ", "Juniper", "Router"),
